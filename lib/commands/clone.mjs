...
export function gitConfigUrl(config, repository) {
  const bitbucketUsername = config.bitbucketUsername || '<undefined>';
  const bitbucketRepoUrl = config.bitbucketRepoUrl || '<undefined>';
  return `https://${bitbucketUsername}@${bitbucketRepoUrl}${repository}.git`;
}
